...
class _SearchPageState extends State<SearchPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _followUser(String userId, String username, bool isCurrentlyFollowing) async {
    try {
      final authService = Provider.of<AuthService>(context, listen: false);
      final currentUserId = authService.currentUser?.id;
      ...
      final uri = Uri.parse('$_baseUrl/follow/$endpoint/$currentUserId/$userId');
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(isCurrentlyFollowing ? 'Unfollowed @$username' : 'Following @$username'),
      ...
      print('[SearchPage] Error following user: $e');
      ScaffoldMessenger.of(context).showSnackBar(
              ...
              trailing: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    if (userId != null) {
                      _followUser(userId, username, isFollowing);
                    }
                  },
